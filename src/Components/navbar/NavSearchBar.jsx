...
function NavSearchBar() {
    ...
    function switchChannel(el) {
        Array.prototype.slice.call(document.querySelectorAll(".searchCatSelector__item")).forEach((element) => {
            element.classList.remove("searchCatSelector__item-active")
        })

        el.classList.add("searchCatSelector__item-active")
    }
    */
    ...
    function changeSearchTypeText(e) {
        setSearchTypeText(prev => {
            ...
            <Form className="search-bar" method="post" role="search" action="/test/" name="nav-search-form">
                    ...
                    <div>
                        <div className="searchCatSelector-menu" data-menu-id="navbar-search-category-select" role="presentation">
                            <div className="menu__items">
                                <ul className="searchCatSelector" role="menu" onClick={changeSearchTypeText}>
                                    {options.map((item) => {
                                        return (item.label === "Divider" ? <li className="searchCatSelector__item-divider"></li> : <li key={item.value}
                ...
                <div className="search_form-input_container" >
                    <div className="input_container">
                        <input className="search-box-input" type="text" name="movie-finder" placeholder="search IMDB" required />
                    </div>
                </div>
