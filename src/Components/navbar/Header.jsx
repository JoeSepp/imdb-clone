    ...
    return (
        <nav className="nav-header">
            <div className="navbar-inner">
                <HamburgerMenu />
                <SearchBar />
                <div className="navbar_imdbpro hover_effect">
                ...
                <div className="navbar_watchlist hover_effect">
                    <svg width="24" height="24" xmlns="http://www.w3.org/2000/svg" className="ipc-icon ipc-icon--watchlist ipc-btn__icon ipc-btn__icon--pre" viewBox="0 0 24 24" fill="currentColor" role="presentation"><path d="M17 3c1.05 0 1.918.82 1.994 1.851L19 5v16l-7-3-7 3V5c0-1.05.82-1.918 1.851-1.994L7 3h10zm-4 4h-2v3H8v2h3v3h2v-3h3v-2h-3V7z" fill="currentColor"></path></svg>
                    <span className="hb__menu-text">Watchlist</span>
                </div>
                <div className="navbar_login hover_effect">
                    <Link to='/account/sign-in' style={linkStyle}>
                        <span className="hb__menu-text">Sign in</span>
                    </Link>
                </div>
                <div className="navbar_localization hover_effect">
                    <span className="hb__menu-text">EN</span>
                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" className="ipc-icon ipc-icon--arrow-drop-down ipc-btn__icon ipc-btn__icon--post navbar__flyout__text-button-post-icon" viewBox="0 0 24 24" fill="currentColor" role="presentation"><path fill="none" d="M0 0h24v24H0V0z"></path><path d="M8.71 11.71l2.59 2.59c.39.39 1.02.39 1.41 0l2.59-2.59c.63-.63.18-1.71-.71-1.71H9.41c-.89 0-1.33 1.08-.7 1.71z"></path></svg>
                </div>
            </div>
        </nav>
    )
